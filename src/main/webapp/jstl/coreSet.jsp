...
request : <%=pageContext.getAttribute("userId")%> /${requestScope.userId}  <br>
session : <%=pageContext.getAttribute("userId")%> /${sessionScope.userId} <br>
application : <%=pageContext.getAttribute("userId")%> /${applicationScope.userId}<br>
